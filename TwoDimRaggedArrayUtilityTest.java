...
public class TwoDimRaggedArrayUtilityTest {
	...
	private double[][] dataSet2 = {{7,2,9,4},
								   ...
								   {8,1,3},
								   {11,6,7,2}};
	private double[][] dataSet3 = {{7.2,2.5,9.3},
			                       {5.9},
			                       {8.1,1.7,3.3},
			                       {11.6,6.9,7.3,2.7}};
	...
	public void testGetLowestInRowIndex() {
		...
		assertEquals(1,TwoDimRaggedArrayUtility.getLowestInRowIndex(dataSet2,2)); //Problem- Because it's a jagged array it's trying to access positions that don't exist
